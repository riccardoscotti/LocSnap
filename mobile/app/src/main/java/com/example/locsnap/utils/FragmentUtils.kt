...
class FragmentUtils {
    companion object {
         ...
         */
        fun getFriends(loggedUser: String, fragment: ChooseFragment, command: String="", imageName: String="") {
            ...
            val getFriendRequest = JsonObjectRequest(
                Request.Method.POST,
                url,
                json,
                { response ->
                        ...
                        for (i in 0 until friendsJson.length()) {
                            ...
                            dialog.setTitle("Who do you want to send your collection to?")
                                .setItems(
                                    ...
                                    if (command == "tag") {
                                        UploadUtils.tagFriend(friends[which], imageName, fragment)
                                    }
//                                    else {
